    ...
    >
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        <header style={{ paddingTop: '52px', paddingBottom: '44px', borderBottom: '1px solid var(--color-outline)' }}>
          ...
          <p style={{ ...BODY_STYLE, maxWidth: '540px' }}>
            Every assumption is editable. Every claim has a source. Below is the
            math the calculator runs and the research it stands on.
          </p>
        </header>
        ...
        <section style={SECTION_STYLE}>
          ...
          <p style={BODY_STYLE}>
            Ben Felix's 5% Rule holds that the annual unrecoverable cost of
            owning a home is roughly 5% of the home price. It breaks into three
            components:
          </p>
          <ul style={{ marginTop: '16px', marginLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', listStyle: 'disc' }}>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>1% property tax</strong> — varies 0.3% to 1.25% by Canadian jurisdiction. We use the provincial median and let you adjust.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>1% maintenance</strong> — Felix's own research suggests 1.5–2.5% in practice. We default to 1.5% (adjustable).
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>3% cost of capital</strong> — the spread between expected equity returns (~4% real) and expected residential returns (~1% real), per Eichholtz et al. 2021.
            </li>
          </ul>
          <p style={{ ...BODY_STYLE, marginTop: '16px' }}>
            If comparable monthly rent is below 5% of the home price divided
            by 12, renting is financially favored. The calculator runs the
            full year-by-year simulation on top of this heuristic.
          </p>
        </section>
        ...
        <section style={SECTION_STYLE}>
          ...
          <p style={BODY_STYLE}>
            Beneath the 5% heuristic, the calculator runs a full simulation
          ...
          <ul style={{ marginTop: '8px', marginLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', listStyle: 'disc' }}>
            ...
            <li style={LI_STYLE}>Each year: pay rent and renter's insurance, then invest the positive difference between the owner's annual cash-out and the renter's (the opportunity cost of ownership).</li>
          ...
          <p style={BODY_STYLE}>
            If you rent a basement suite or secondary unit, the net monthly income
            reduces the owner's effective annual cash-out. This shifts the
            invest-the-difference calculation in the owner's favor. The suite
            income grows at the same annual rate as rent.
          </p>
        </section>
        ...
        <section style={SECTION_STYLE}>
          ...
          <ul style={{ marginTop: '8px', marginLeft: '20px', display: 'flex', flexDirection: 'column', gap: '12px', listStyle: 'disc' }}>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>Mortgage math:</strong> Canadian semi-annual compounding (Interest Act). Effective monthly rate is{' '}
              <code style={{ fontSize: '13px', color: 'var(--color-text)', backgroundColor: 'var(--color-bg-subtle)', padding: '1px 4px', borderRadius: '3px' }}>
                (1 + annualRate / 2)^(1/6) - 1
              </code>
              , not annualRate / 12.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>Land transfer tax:</strong> provincial brackets for every province, plus Toronto's Municipal LTT layered on when applicable. First-time-buyer rebates applied automatically.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>CMHC insurance:</strong> 4.0% / 3.1% / 2.8% premium schedule for 5% / 10% / 15% down payments. Homes above $1.5M are not CMHC-eligible.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>Capital gains:</strong> 50% inclusion at your marginal rate on the renter's portfolio gains at exit. The Principal Residence Exemption covers the owner's home gain.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>Mortgage interest:</strong> not deductible against employment income in Canada — a key difference from the US model.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>TFSA:</strong> $7,000/yr new room. Tax-free growth, no capital gains tax at exit. Room accumulates by year relative to your birth year.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>FHSA:</strong> $8,000/yr tax-deductible, tax-free growth. Up to $40,000 lifetime. First-time buyers only.
            </li>
            <li style={LI_STYLE}>
              <strong style={{ color: 'var(--color-text)' }}>RRSP:</strong> 18% of earned income per year, max $31,560. Deferred tax at withdrawal. Refunds reinvested.
            </li>
          </ul>
        </section>
        ...
        <section style={SECTION_STYLE}>
          ...
          <p style={BODY_STYLE}>
            PWL Capital's 20-year Canadian backtest (Rational Reminder episode
            323, September 2025) used the following parameters:
          </p>
          <ul style={{ marginTop: '16px', marginLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', listStyle: 'disc' }}>
          ...
          >
            <p style={{ fontSize: '13px', color: 'var(--color-text-muted)', lineHeight: 1.65 }}>
              <strong style={{ color: 'var(--color-text)' }}>Headline result:</strong> Renters won 7 of 12 Canadian
        ...
        {/* Sensitivity */}
        <section style={SECTION_STYLE}>
          <h2 style={H2_STYLE}>Sensitivity scenarios</h2>
          <p style={BODY_STYLE}>
            The result page shows five scenarios toggled by pill buttons:
          </p>
          <ul style={{ marginTop: '16px', marginLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px', listStyle: 'disc' }}>
            <li style={LI_STYLE}><strong style={{ color: 'var(--color-text)' }}>Base</strong> — your exact inputs.</li>
            <li style={LI_STYLE}><strong style={{ color: 'var(--color-text)' }}>Growth +2%</strong> — home appreciation 2 percentage points higher.</li>
            <li style={LI_STYLE}><strong style={{ color: 'var(--color-text)' }}>Growth -2%</strong> — home appreciation 2 percentage points lower.</li>
            <li style={LI_STYLE}><strong style={{ color: 'var(--color-text)' }}>Rate +1%</strong> — mortgage rate 1 percentage point higher.</li>
            <li style={LI_STYLE}><strong style={{ color: 'var(--color-text)' }}>Rate -1%</strong> — mortgage rate 1 percentage point lower.</li>
          </ul>
        </section>
        ...
        <section style={{ paddingTop: '36px', paddingBottom: '36px' }}>
          ...
          <ol style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '20px', paddingLeft: '0', listStyle: 'none' }}>
            {CITATIONS.map((c, i) => (
              ...
              >
                <p style={{ fontSize: '13px', color: 'var(--color-text)', lineHeight: 1.6, marginBottom: '6px' }}>
                  ...
                  {c.url ? (
                    <a
                      ...
                      style={{ color: 'var(--color-text)', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: 'var(--color-outline-active)' }}
                    >
                      {c.title}
                    </a>
                  ) : (
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-text-muted)', lineHeight: 1.6, marginBottom: '3px' }}>
