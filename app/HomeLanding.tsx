  ...
  return (
    <div style={{ flexShrink: 0, textAlign: 'right' }}>
      ...
      <motion.p
        ...
        style={{ fontSize: '11px', color: '#71717A', marginTop: '6px', maxWidth: '160px', lineHeight: 1.4, marginLeft: 'auto' }}
      >
        {stat.label}
      </motion.p>
    </div>
        ...
        >
          ...
          <nav style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              <button onClick={() => setMethodologyOpen(true)} style={{ fontSize: '13px', color: '#71717A', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'var(--font-sans), system-ui, sans-serif', letterSpacing: '-0.01em', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: 'rgba(255,255,255,0.12)' }}>
                How this works
              </button>
              <button onClick={() => setFaqOpen(true)} style={{ fontSize: '13px', color: '#71717A', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'var(--font-sans), system-ui, sans-serif', letterSpacing: '-0.01em', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: 'rgba(255,255,255,0.12)' }}>
                FAQ
              </button>
          ...
          >
            <AnimatePresence mode="wait">
              {!isCta && beat && (
                ...
                >
                  <p style={{ fontSize: '10px', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#71717A', marginBottom: '20px', fontWeight: 500 }}>
                    {beat.eyebrow}
                  </p>
                    ...
                    {bodyVisible && (
                      ...
                      >
                        <div style={{ flex: '1 1 300px' }}>
                          <p style={{ fontSize: 'clamp(15px, 1.8vw, 18px)', color: '#A1A1AA', lineHeight: 1.65, letterSpacing: '-0.01em', marginBottom: beat.source ? '12px' : 0 }}>
                            {beat.body}
                          </p>
                          {beat.source && (
              ...
              {isCta && (
                ...
                >
                  <div style={{ marginBottom: '28px' }}>
                    <ReckonSignature color="#52525B" width={64} />
                  </div>
                  <h2 style={{
                    fontFamily: 'var(--font-serif), Georgia, serif',
